...
+---------------+----------------------+------------------------+
|package name   | mnecsd          | mnefoo                 |
+---------------+----------------------+------------------------+
|import example | import mnecsd   | import mnefoo          |
+---------------+----------------------+------------------------+
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Replace all occurrences of ``mnecsd`` and ``mne-csd``
...
In linux machine::
    ...
    $ git grep -l 'mnecsd' | xargs sed -i 's/mnecsd/mnefoo/g'
    $ git grep -l 'mne-csd' | xargs sed -i 's/mne-csd/mne-foo/g'

this is how to do it in Macosx machine::

    $ git grep -l 'mnecsd' | xargs sed -i '' -e 's/mnecsd/mnefoo/g'
    $ git grep -l 'mne-csd' | xargs sed -i '' -e 's/mne-csd/mne-foo/g'
